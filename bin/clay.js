...
if(argv.v){
  ...
  var help = [
    ...
    "",
    "  register               Registers with Clay and Login to Salesforce",
    "",
    "  users                  Displays list of salesforce organizations logins",
    "",
    "  users --add            Login and stores a new salesforce organization",
    "",
    "  users --remove         Removes salesforce organization login from the list",
    "",
